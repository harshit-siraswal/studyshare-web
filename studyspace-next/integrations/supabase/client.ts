...
const SUPABASE_URL = getEnv('NEXT_PUBLIC_SUPABASE_URL') || DEFAULT_SUPABASE_URL;
...
if (!SUPABASE_URL) missingSupabaseVars.push('NEXT_PUBLIC_SUPABASE_URL');
if (!SUPABASE_PUBLISHABLE_KEY) missingSupabaseVars.push('NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY');
