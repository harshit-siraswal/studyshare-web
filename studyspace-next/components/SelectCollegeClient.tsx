...
const SelectCollege = () => {
    ...
    useEffect(() => {
                    ...
                    initialColleges
                        ...
                        .map(async (college) => {
                            const { count, error } = await supabaseAny
                                // The production project includes a `users` table that is missing from generated typings.
                                // Keep the runtime query unchanged for now and narrow the cast to this legacy query.
                                .from('users')
        ...
        const scheduledTask = usedIdleCallback
...
export { SelectCollege as SelectCollegeClient };
