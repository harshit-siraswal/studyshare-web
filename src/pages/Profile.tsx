...
import { ArrowLeft, Crown, CreditCard, FileText, Video, HelpCircle, Users, LogOut, Edit2, Search, Camera, X, Check, MoreVertical, Trash2, Bookmark, Loader2, Sparkles, Mail, AlertTriangle } from "lucide-react";
...
const DEFAULT_AI_TOKEN_BASE_BUDGET = 40000;
...
const Profile = () => {
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      ...
      toast.success(`Password reset email sent to ${authUser.email}.`);
    } catch (error: any) {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      setAccountActionLoading(true);
      await api.deleteMyAccount(deleteConfirmation.trim());
      await logout();
  ...
  return (
    <div className="min-h-screen bg-background pb-20 sm:pb-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Send yourself a password reset link or permanently delete
                      this account and its personal data.
                    </p>
                  </div>
                </div>
      ...
      >
        <DialogContent className="mx-4 max-w-md sm:mx-0">
          <DialogHeader>
            ...
            <DialogDescription>
              This permanently removes your account access and clears personal
              data tied to your StudyShare profile. Type <strong>DELETE</strong>
              {" "}to continue.
            </DialogDescription>
          </DialogHeader>
