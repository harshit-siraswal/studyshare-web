  ...
  "rounded-xl border text-card-foreground",
  {
    variants: {
      variant: {
        ...
        interactive: "bg-card border-border shadow-card hover:shadow-hover hover:border-primary/30 transition-all duration-300 cursor-pointer hover:-translate-y-1",
      },
    },
    defaultVariants: {
      variant: "default",
