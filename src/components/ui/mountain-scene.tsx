...
export function GenerativeMountainScene() {
    ...
    useEffect(() => {
        ...
        const material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                color: { value: new THREE.Color("#047857") }, // Darker, richer emerald
            },
            vertexShader: `
        uniform float time;
    ...
    return <div ref={mountRef} className="absolute inset-0 w-full h-[70vh] bottom-0 mt-auto z-0 opacity-40 mix-blend-screen" style={{ maskImage: "linear-gradient(to bottom, transparent, black 20%, black 80%, transparent)" }} />;
}
