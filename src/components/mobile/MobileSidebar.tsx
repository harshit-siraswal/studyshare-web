...
import { X, Moon, Sun, LogOut, FileText, BookOpenCheck, Users, Search, Download, Sparkles, Smartphone } from 'lucide-react';
...
const menuItems = [
    ...
    { icon: Smartphone, label: 'Android App', path: '/mobile-app' },
